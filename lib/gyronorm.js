...
(function(root, factory) {
  ...
  */
  ...
  GyroNorm.prototype.isDeviceOrientationAvailable = function() {
    var doSnapShot = this._getScreenAdjustedEuler();

    return isPresent(doSnapShot) && isPresent(doSnapShot.alpha) && isPresent(doSnapShot.beta) && isPresent(doSnapShot.gamma);
  };

  GyroNorm.prototype.isAccelerationAvailable = function() {
    var accSnapShot = this._getScreenAdjustedAcceleration();

    return isPresent(accSnapShot) && isPresent(accSnapShot.x) && isPresent(accSnapShot.y) && isPresent(accSnapShot.z);
  };
