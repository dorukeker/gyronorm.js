...
!function(a,b){"function"==typeof define&&define.amd?define(function(){return a.GyroNorm=b()}):"object"==typeof module&&module.exports?module.exports=a.GyroNorm=b():a.GyroNorm=b()}(this,function(){function a(a){return Math.round(a*Math.pow(10,n))/Math.pow(10,n)}function b(){var b={};b=p?i.getScreenAdjustedEuler():i.getFixedFrameEuler();var c=j.getScreenAdjustedAcceleration(),d=j.getScreenAdjustedAccelerationIncludingGravity(),g=j.getScreenAdjustedRotationRate(),h=0;m===q?(h=b.alpha-e,h=0>h?360-Math.abs(h):h):h=b.alpha;var k={"do":{alpha:a(h),beta:a(b.beta),gamma:a(b.gamma),absolute:i.isAbsolute()},dm:{x:a(c.x),y:a(c.y),z:a(c.z),gx:a(d.x),gy:a(d.y),gz:a(d.z),alpha:a(g.alpha),beta:a(g.beta),gamma:a(g.gamma)}};return l&&(k.dm.gx*=f,k.dm.gy*=f,k.dm.gz*=f),k}function c(a){o&&("string"==typeof a&&(a={message:a,code:0}),o(a))}var d=null,e=0,f=0,g=!1,h=!1,i=null,j=null,k=50,l=!0,m="game",n=2,o=null,p=!1,q="game",r=function(){};return r.prototype.GAME="game",r.prototype.WORLD="world",r.prototype.DEVICE_ORIENTATION="deviceorientation",r.prototype.ACCELERATION="acceleration",r.prototype.ACCELERATION_INCLUDING_GRAVITY="accelerationinludinggravity",r.prototype.ROTATION_RATE="rotationrate",r.prototype.init=function(a){return a&&a.frequency&&(k=a.frequency),a&&a.gravityNormalized&&(l=a.gravityNormalized),a&&a.orientationBase&&(m=a.orientationBase),a&&a.decimalCount&&(n=a.decimalCount),a&&a.logger&&(o=a.logger),a&&a.screenAdjusted&&(p=a.screenAdjusted),new Promise(function(a,b){var c=!1,d=!1;new FULLTILT.getDeviceOrientation({type:m}).then(function(b){i=b,c=!0,c&&d&&(h=!0,a())})["catch"](function(a){b(a)}),(new FULLTILT.getDeviceMotion).then(function(b){j=b,f=j.getScreenAdjustedAccelerationIncludingGravity().z>0?1:-1,d=!0,c&&d&&(h=!0,a())})["catch"](function(a){b(a)})})},r.prototype.end=function(){try{h=!1,this.stop(),j.stop(),i.stop()}catch(a){c(a)}},r.prototype.start=function(a){return h?(d=setInterval(function(){a(b())},k),void(g=!0)):void c({message:'GyroNorm is not initialized yet. First call the "init()" function.',code:1})},r.prototype.stop=function(){d&&(clearInterval(d),g=!1)},r.prototype.normalizeGravity=function(a){l=a?!0:!1},r.prototype.setHeadDirection=function(){return p||m===this.WORLD?!1:(e=i.getFixedFrameEuler().alpha,!0)},r.prototype.startLogging=function(a){a&&(o=a)},r.prototype.stopLogging=function(){o=null},r.prototype.isAvailable=function(a){switch(a){case this.DEVICE_ORIENTATION:return i.isAvailable(i.ALPHA)&&i.isAvailable(i.BETA)&&i.isAvailable(i.GAMMA);case this.ACCELERATION:return j.isAvailable(j.ACCELERATION_X)&&j.isAvailable(j.ACCELERATION_Y)&&j.isAvailable(j.ACCELERATION_Z);case this.ACCELERATION_INCLUDING_GRAVITY:return j.isAvailable(j.ACCELERATION_INCLUDING_GRAVITY_X)&&j.isAvailable(j.ACCELERATION_INCLUDING_GRAVITY_Y)&&j.isAvailable(j.ACCELERATION_INCLUDING_GRAVITY_Z);case this.ROTATION_RATE:return j.isAvailable(j.ROTATION_RATE_ALPHA)&&j.isAvailable(j.ROTATION_RATE_BETA)&&j.isAvailable(j.ROTATION_RATE_GAMMA);default:return{deviceOrientationAvailable:i.isAvailable(i.ALPHA)&&i.isAvailable(i.BETA)&&i.isAvailable(i.GAMMA),accelerationAvailable:j.isAvailable(j.ACCELERATION_X)&&j.isAvailable(j.ACCELERATION_Y)&&j.isAvailable(j.ACCELERATION_Z),accelerationIncludingGravityAvailable:j.isAvailable(j.ACCELERATION_INCLUDING_GRAVITY_X)&&j.isAvailable(j.ACCELERATION_INCLUDING_GRAVITY_Y)&&j.isAvailable(j.ACCELERATION_INCLUDING_GRAVITY_Z),rotationRateAvailable:j.isAvailable(j.ROTATION_RATE_ALPHA)&&j.isAvailable(j.ROTATION_RATE_BETA)&&j.isAvailable(j.ROTATION_RATE_GAMMA)}}},r.prototype.isRunning=function(){return g},r});